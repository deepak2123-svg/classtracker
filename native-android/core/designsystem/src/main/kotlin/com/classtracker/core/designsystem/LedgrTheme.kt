...
private val LightExtendedColors = LedgrExtendedColors(
    ...
    classCardBorder = LedgrInk.copy(alpha = 0.68f),
    dragHandle = LedgrInk.copy(alpha = 0.48f),
    successStrong = Color(0xFF047A3C),
    indicatorInactive = Color(0xFFBDBEC4),
    loggedIndicatorInactive = Color(0xFFBDBEC4),
    miniPillSurface = Color.White.copy(alpha = 0.62f),
    miniPillProminentSurface = Color.White.copy(alpha = 0.82f),

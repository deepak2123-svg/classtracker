...
private val LightExtendedColors = LedgrExtendedColors(
    ...
    classCardBorder = LedgrForest.copy(alpha = 0.08f),
    dragHandle = LedgrInk.copy(alpha = 0.32f),
    successStrong = Color(0xFF047A3C),
    indicatorInactive = Color(0xFFBDBEC4),
    loggedIndicatorInactive = Color(0xFFBDBEC4),
    miniPillSurface = Color.White.copy(alpha = 0.82f),
    miniPillProminentSurface = Color.White.copy(alpha = 0.9f),

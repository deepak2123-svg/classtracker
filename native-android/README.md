...
Phase 4 checkpoint 7 includes native Firebase authentication, compatibility
...
newest-first history, and left/right class swiping. Production native builds
remain read-only, and the teacher/admin web applications continue to use the
existing Firestore model.

See `../docs/native-android-phase-4-checkpoint-7.md` for the latest
class-detail navigation polish, verification, and rollback details. See
